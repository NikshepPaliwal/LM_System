...
// array list for data on spinner
        ...
        search_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                all_classes();
                item.clear();
                Toast.makeText(allClasslist.this, "This Page is under development", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void all_classes() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Libraries").child(userId).child("Students Card").child(className);
